...
MATCH_TIMEOUT = "Timeout da partida, vamos ver quantas garrafas pediram a cada voluntário"
...
while status != EVENT_END and bottles >= 0:
  ...
  if status == MATCH_END:
    ...
    if bottles >= players:
      ...
      print(f"Não teremos água para todos os jogadores... Temos que garantir {players-bottles} garrafas!!")
      bottles *= 2
      bottles -= players
